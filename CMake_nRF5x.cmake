...
macro(nRF5x_setup)
    ...
    if (NRF_TARGET MATCHES "nrf51")
        ...
        add_definitions(-DBOARD_${BOARD} -DNRF51 -DNRF51422 -DS130 -DBSP_UART_SUPPORT)
...
macro(nRF5x_addExecutable EXECUTABLE_NAME SOURCE_FILES)
    ...
    # TODO Change linker script. Now start write image to invalid memory address
...
macro(nRF5x_addBSP WITH_BLE_BTN WITH_ANT_BTN WITH_NFC)
    ...
    if (${WITH_BLE_BTN})
        list(APPEND SDK_SOURCE_FILES
                "${NRF5_SDK_PATH}/examples/bsp/bsp_btn_ble.c"
                )
    endif ()
...
endmacro(nRF5x_addBLEServiceNUS)

macro(nRF5x_addBLEServiceNUSc)
    include_directories(
...
endmacro(nRF5x_addBLEServiceNUSc)

macro(nRF5x_addBLEDBDiscovery)
    include_directories(
            "${NRF5_SDK_PATH}/components/ble/ble_db_discovery"
            "${NRF5_SDK_PATH}/components/libraries/trace/"
    )

    list(APPEND SDK_SOURCE_FILES
            "${NRF5_SDK_PATH}/components/ble/ble_db_discovery/ble_db_discovery.c"
            "${NRF5_SDK_PATH}/components/libraries/trace/app_trace.c"
            )

endmacro(nRF5x_addBLEDBDiscovery)
